...
ll recur(vector<int>& v, int l, int r, bool & flag){
    // debug(l)
    // debug(r)
    if(r==l+1){
    ...
    if(ma1>ma2){
        return recur(v, l, mid, flag)+recur(v, mid+1, r, flag)+1;
    }
    return recur(v, l, mid, flag)+recur(v, mid+1, r, flag);
}
