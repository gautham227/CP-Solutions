...
// #endif
    ...
    while(t--){
        ...
        int cntx1=count(a.begin(),a.end(),'X');
        int cntx2=count(b.begin(),b.end(),'X');
        int cnts1=count(a.begin(),a.end(),'S');
        int cnts2=count(b.begin(),b.end(),'S');
        int cntm1=count(a.begin(),a.end(),'M');
        int cntm2=count(b.begin(),b.end(),'M');
        int cntl1=count(a.begin(),a.end(),'L');
        int cntl2=count(b.begin(),b.end(),'L');
        if(cnts1<cnts2){
            cout<<">"<<endl;
            continue;
        }
        ...
        else if(cntx1<cntx2 and cnts1==0){
            cout<<"<"<<endl;
            continue;
        }
        else if(cntx1>cntx2 and cnts1==0){
